...
Note: Some key packages are kept updated in my default Python environment and in each virtual environment.
...
There are some great options for deploying/publishing notebooks for free. 
